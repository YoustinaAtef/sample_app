...
describe User do
  ...
  it "should reject email identical addresses up to case" do
  ...
  describe "password encryption" do
    ...
    it "should have an encrypted pasword" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil on email/passwod mismatch" do
      ...
      it "should return the user for email/password match" do
  ...
  describe "micropost associations" do
    ...
    it "should have the right microposts in the right order" do
      @user.microposts.should eq([@mp2, @mp1])
    end  
    
    # it "should destroy the associatied microposts" do
      # @user.destroy
    ...
    describe "status feed" do
      ...
      it "should not include a different user's microposts" do
        mp3 = Factory(:micropost, :user => Factory(:user, :email => "anotheremail@example.com"))
        @user.feed.should_not include(mp3)
      end
      
      it "should include the microposts of followed users" do
        followed = Factory(:user, :email => "other@yahoo.com")
